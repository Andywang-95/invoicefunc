...
"}")
        ...
        self.invoice_b_text.setMinimumSize(QtCore.QSize(50, 31))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(10)
        ...
        self.invoice_b_num = QtWidgets.QTextEdit(self.widget_2)
        self.invoice_b_num.setMinimumSize(QtCore.QSize(256, 32))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.invoice_b_num.setFont(font)
        self.invoice_b_num.setStyleSheet("max-height: 30px")
        ...
        self.invoice_e_text.setMinimumSize(QtCore.QSize(50, 31))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(10)
        ...
        self.invoice_e_num = QtWidgets.QTextEdit(self.widget_3)
        self.invoice_e_num.setMinimumSize(QtCore.QSize(256, 32))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.invoice_e_num.setFont(font)
        self.invoice_e_num.setStyleSheet("max-height: 30px")
        ...
        self.open.setMinimumSize(QtCore.QSize(70, 31))
        self.open.setMaximumSize(QtCore.QSize(70, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.save.setMinimumSize(QtCore.QSize(70, 31))
        self.save.setMaximumSize(QtCore.QSize(70, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.start.setMinimumSize(QtCore.QSize(65, 31))
        ...
        self.output_text.setMinimumSize(QtCore.QSize(0, 15))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setBold(True)
        font.setWeight(75)
